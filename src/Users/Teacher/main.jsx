...
//   useEffect(() => {
//     MeritService.getTeacherStats2().then((response) => {
...
const TeacherMeritDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await MeritService.getTeacherStats2();
        setData(response.data);
        // Set the initial selected class to the first class in the data
  ...
  const stats = data[selectedClass];
